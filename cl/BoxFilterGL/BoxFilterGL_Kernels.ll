; ModuleID = '../AMDAPP_samples/cl/BoxFilterGL/BoxFilterGL_Kernels.cl'
source_filename = "../AMDAPP_samples/cl/BoxFilterGL/BoxFilterGL_Kernels.cl"
...
!4 = !{!"none", !"none", !"none"}
!5 = !{!"uint4*", !"uchar4*", !"int"}
!6 = !{!"uint __attribute__((ext_vector_type(4)))*", !"uchar __attribute__((ext_vector_type(4)))*", !"int"}
!7 = !{!"", !"", !""}
!8 = !{!9, !9, i64 0}
